...
class ProcessOrderViaPosTest extends TestCase
{
    ...
    public function test_pos_processing_serial_override(): void
    {
        ...
        // Order conversion is intentionally a separate sales path from the
        // normal POS checkout.  It must invoke the same lifecycle guard.
        $this->mock(SerialBusinessTimeGuard::class, function ($mock): void {
            $mock->shouldReceive('assertNewSaleCanUseBusinessTime')->once();
        });
