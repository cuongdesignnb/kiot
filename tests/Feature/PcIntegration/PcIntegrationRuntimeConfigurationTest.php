...
class PcIntegrationRuntimeConfigurationTest extends PcIntegrationTestCase
{
    ...
    public function test_connection_endpoint_reports_safe_capabilities_and_records_handshake_metadata(): void
    {
        ...
        $response->assertOk()
            ...
            ->assertJsonPath('capabilities.categories', true)
            ->assertJsonPath('capabilities.product_images', true)
            ->assertJsonPath('capabilities.price_books', true)
            ->assertJsonPath('capabilities.repair_status', true)
