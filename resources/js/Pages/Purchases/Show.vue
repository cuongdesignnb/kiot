    ...
    <AppLayout>
        <div class="bg-white h-full flex flex-col">
                    ...
                    <div class="grid grid-cols-3 gap-x-8 gap-y-3 mb-6 text-[13px]">
                        ...
                        <div class="row-span-3">
                            <div class="flex items-start gap-2">
                                ...
                                <span class="text-gray-400 italic text-[13px]">Ghi chú: {{ purchase.note || '—' }}</span>
                            </div>
                        </div>
                        <div class="flex gap-2">
            ...
            <div class="flex items-center justify-between px-4 py-3 border-t border-gray-200 bg-gray-50/50">
                ...
                <div class="flex items-center gap-2">
                    <Link v-if="purchase.status !== 'cancelled' && can('purchases.edit')" :href="`/purchases/${purchase.id}/edit`"
