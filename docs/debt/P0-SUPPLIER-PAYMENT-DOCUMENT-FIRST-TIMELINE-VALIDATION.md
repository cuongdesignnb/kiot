...
CASHFLOW_REFERENCE_ID=REDACTED_FIXTURE_CASHFLOW_ID
CASHFLOW_REFERENCE_CODE=PRODUCTION_PAYMENT_REDACTED
FIRST_PURCHASE_NOT_EXPOSED_AS_PARENT=PASS
DISPLAY_GROUP_KEY=cash_flows|REDACTED_FIXTURE_CASHFLOW_ID|supplier_payment (authoritative identity)
...
DISTINCT_PAYMENTS_NOT_MERGED=PASS (distinct CashFlow identities in unit fixture)
