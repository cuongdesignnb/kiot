...
use App\Services\Integrations\PcWebsite\PcCategorySyncService;
...
class CategorySyncController extends Controller
{
    ...
    public function __invoke(CatalogSyncRequest $request, PcCategorySyncService $service): JsonResponse
    {
        try {
