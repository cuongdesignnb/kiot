        ...
        return [
            ...
            'Kho hàng' => [
                '_sub' => [
                    'Chuyển hàng' => [
                        ...
                        'stock_transfers.receive' => 'Nhận hàng chuyển kho (Step 24.0B)',
                        'stock_transfers.cancel' => 'Hủy phiếu chuyển hàng (Step 24.0B)',
                    ...
                    'Kiểm kho' => [
                        ...
                        'stock_takes.balance' => 'Cân bằng kiểm kho (Step 24.0B)',
                        'stock_takes.cancel' => 'Hủy phiếu kiểm kho (Step 24.0B)',
                    ...
                    'Xuất hủy' => [
                        ...
                        'damages.cancel' => 'Hủy phiếu xuất hủy (Step 24.0B)',
            ...
            'Khách hàng' => [
                '_sub' => [
                    ...
                    'Cấn trừ công nợ' => [
                        'debt_offsets.view' => 'Xem yêu cầu cấn trừ công nợ',
                        'debt_offsets.create' => 'Tạo và sửa yêu cầu cấn trừ',
                        'debt_offsets.submit' => 'Gửi yêu cầu cấn trừ để duyệt',
                        'debt_offsets.approve' => 'Duyệt yêu cầu cấn trừ',
                        'debt_offsets.reject' => 'Từ chối yêu cầu cấn trừ',
                        'debt_offsets.apply' => 'Áp dụng cấn trừ vào công nợ',
                        'debt_offsets.reverse' => 'Đảo phiếu cấn trừ đã áp dụng',
                        'debt_offsets.void' => 'Hủy yêu cầu cấn trừ chưa áp dụng',
                    ],
                ],
            ],
            'Bán hàng' => [
            ...
            'Nhân viên' => [
                '_sub' => [
                    'Danh sách nhân viên' => [
                        ...
                        'employee.view_salary_balance' => 'Xem số dư nợ và tạm ứng',
                    ],
                    ...
                    'Bảng tính lương, thanh toán lương' => [
                        ...
                        'payroll.edit' => 'Sửa bảng lương chưa chốt',
                        'payroll.lock' => 'Chốt bảng lương',
                        'payroll.cancel' => 'Hủy bảng lương',
                        'payroll.pay' => 'Thanh toán lương',
                        'payroll.pay.cancel' => 'Hủy thanh toán lương',
                        'payroll.adjust' => 'Điều chỉnh nợ và tạm ứng',
                        'payroll.advance.create' => 'Tạo tạm ứng lương',
                        'payroll.advance.cancel' => 'Hủy tạm ứng lương',
                        'payroll.ledger.view' => 'Xem timeline nợ và tạm ứng',
                        'payroll.ledger.export' => 'Xuất timeline nợ và tạm ứng',
                        'payroll.reconciliation.view' => 'Xem đối soát nợ lương và tạm ứng',
                        'payroll.reconciliation.export' => 'Xuất đối soát nợ lương và tạm ứng',
                        'payroll.rebuild_balance' => 'Tính lại số dư lương',
                        'payroll.override_locked_period' => 'Override kỳ khóa sổ payroll',
                        'payroll.override_backdate_limit' => 'Override giới hạn nhập lùi ngày payroll',
                    ],
            ...
            'Công việc & Sửa chữa' => [
                ...
                'tasks.complete_external' => 'Hoàn thành sửa chữa khách ngoài (Step 24.0B)',
                'tasks.manage_parts' => 'Quản lý linh kiện',
                'tasks.attach_warranty' => 'Gắn bảo hành vào phiếu sửa chữa (Step 24.0B)',
                'tasks.apply_warranty_policy' => 'Áp chính sách miễn phí bảo hành (Step 24.0B)',
                'tasks.disassemble' => 'Bóc tách linh kiện (Step 24.0B)',
